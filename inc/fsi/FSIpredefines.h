...
// Project setup
#define FSI_DEFAULT_CPP_STD			201103L

// Versioning
#define FSI_VERSION_MAJOR            0
#define FSI_VERSION_MINOR            0
#define FSI_VERSION_PATCH            0

#define FSI_VERSION_STD              0

// Version states:
// * dev
// * beta
// * build
#define FSI_VERSION_STATE          "dev"

#define FSI_VERSION                ((FSI_VERSION_MAJOR<<16)|(FDX_VERSION_MINOR<<8)|(FDX_VERSION_PATCH)|(FDX_VERSION_STATE << 24))

#define FSI_VERSION_CHECK(FSI_VERSION_MAJOR, FDX_VERSION_MINOR, FDX_VERSION_PATCH, FDX_VERSION_STATE) \
    (((FSI_VERSION_MAJOR)<<16)|((FSI_VERSION_MINOR)<<8)|(FDX_VERSION_PATCH)|((FDX_VERSION_STATE) << 24))
